...
void main() {
	...
	int j, z;
	int i = 0;
	ofstream Guardado("Cita.txt", ios::out);
	bool continuar;
	bool validar = false;
	int cont = 0;
	...
	do {
		system("cls");
		cout << "consultorio del dentista" << endl;
		...
		case 1:
			...
			while (op == 1) {
				do {
					...
					system("pause>nul");
					system("cls");
					cout << "quiere agregar otra cita? Si=1 No=2 " << endl;
					cin >> op;
					i++;
					system("pause>nul");
				} while (op == 1);
			...
			break;
		case 2:
			cout << "quieres modificar una cita vigente? Si=1 No=2 " << endl;
			cin >> op;
			system("cls");
			while (op == 1) {
		...
		case 6:
			system("cls");
			cout << "Guardando la informacion espere porfavor." << endl;
			if (Guardado.is_open()) {
				for (int k = 0; k < i; k++) {

					Guardado << "ID de cita: " << Acita[k].cita << endl;
					Guardado << "\nNombre del paciente: " << Acita[k].nom;
					Guardado << "\nHora del tratamiento (en formato 24hrs): " << Acita[k].hor;
					Guardado << "\nNombre del tratamient: " << Acita[k].ntra;
					Guardado << "\nDescripcion: " << Acita[k].desc;
